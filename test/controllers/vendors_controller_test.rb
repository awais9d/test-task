...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference("Vendor.count") do
      post vendors_url, params: { vendor: { email: @vendor.email, username: @vendor.username } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { email: @vendor.email, username: @vendor.username } }
